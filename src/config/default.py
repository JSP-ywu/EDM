...
_CN.EDM.DEPTH_INJECTION.D_MODEL = 256
_CN.EDM.DEPTH_INJECTION.LAYER_NAMES = ["self", "cross"] * 2
_CN.EDM.DEPTH_INJECTION.NHEAD = 8
_CN.EDM.DEPTH_INJECTION.AGG_SIZE0 = 1
_CN.EDM.DEPTH_INJECTION.AGG_SIZE1 = 1
_CN.EDM.DEPTH_INJECTION.ROPE = True
_CN.EDM.DEPTH_INJECTION.NPE = None

_CN.EDM.DEPTH_FUSION = CN()
_CN.EDM.DEPTH_FUSION.D_MODEL = 256
_CN.EDM.DEPTH_FUSION.LAYER_NAMES = ["cross"] * 2
